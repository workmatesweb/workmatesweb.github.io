        ...
        <div class="row">
            ...
            <div class="col-md-3 p-3" id="sidebar">
                <div class="profile-card-one p-3 text-center">
                    <h5 style="margin-bottom: 20px;"><strong>Good morning,</strong>Minnie</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="profile-card p-3 rounded shadow-sm">
                            ...
                            <p><strong>Full Name:</strong> Minnie</p>
                            <p><strong>Username:</strong> minnie_1</p>
                            <p><strong>Email:</strong> <a href="mailto:minnie@gmail.com">minnie@gmail.com</a></p>
                            <p><strong>Phone number:</strong> +621234567990</p>
                        </div>
                    </div>
    
                    <!-- Dokumen & Kategori Pekerjaan -->
                    <div class="col-md-6">
                        <div class="profile-card p-3 rounded shadow-sm">
                            <div class="d-flex justify-content-between">
                                <h5>Document & Job Category</h5>
                                <button class="btn btn-outline-dark">Edit</button>
                            </div>
                            <hr>
